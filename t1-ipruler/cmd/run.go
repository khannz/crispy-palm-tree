...
var rootCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		logging.WithFields(logrus.Fields{
			...
			"ipRule address": viperConfig.GetString(ipRuleAddressName),
			"ipRule timeout": viperConfig.GetDuration(ipRuleTimeoutName),
		...
		// up grpc api
		grpcServer := application.NewGrpcServer(viperConfig.GetString(ipRuleAddressName), facade, logging) // gorutine inside
