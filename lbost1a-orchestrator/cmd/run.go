...
import (
	...
	"github.com/khannz/crispy-palm-tree/lbost1a-orchestrator/application"
...
var rootCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		logging.WithFields(logrus.Fields{"event id": idForRootProcess}).Info("orchestrator running")
