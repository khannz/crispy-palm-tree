...
func createServicesInfoForTests(applicattionServersOne map[string]*domain.ApplicationServer, applicattionServersTwo map[string]*domain.ApplicationServer) (*domain.ServiceInfo, *domain.ServiceInfo, *domain.ServiceInfo) {
...
func createApplicationServersForTests() (map[string]*domain.ApplicationServer, map[string]*domain.ApplicationServer, *domain.ApplicationServer) {
	...
	mapOne := map[string]*domain.ApplicationServer{appSrvOne.IP + ":" + appSrvOne.Port: appSrvOne, appSrvTwo.IP + ":" + appSrvTwo.Port: appSrvTwo, appSrvFive.IP + ":" + appSrvFive.Port: appSrvFive}
	mapTwo := map[string]*domain.ApplicationServer{appSrvThree.IP + ":" + appSrvThree.Port: appSrvThree, appSrvFour.IP + ":" + appSrvFour.Port: appSrvFour}

	return mapOne, mapTwo, appSrvSix
}
...
func (mockHCWorker *MockHCWorker) StartHealthchecksForCurrentServices([]*domain.ServiceInfo, string) error {
	return nil
}
func (mockHCWorker *MockHCWorker) NewServiceToHealtchecks(*domain.ServiceInfo, string) error {
	return nil
}
func (mockHCWorker *MockHCWorker) RemoveServiceFromHealtchecks(*domain.ServiceInfo, string) error {
	return nil
}
func (mockHCWorker *MockHCWorker) UpdateServiceAtHealtchecks(*domain.ServiceInfo, string) (*domain.ServiceInfo, error) {
	return nil, nil
}
func (mockHCWorker *MockHCWorker) GetServiceState(*domain.ServiceInfo, string) (*domain.ServiceInfo, error) {
	return nil, nil
}
func (mockHCWorker *MockHCWorker) GetServicesState(string) ([]*domain.ServiceInfo, error) {
	return nil, nil
}
