...
const (
	...
	tunnelAddressName = "tunnel-address"
...
func init() {
	...
	pflag.String(orchAddressName, defaultOrchAddress, "hc address")
	pflag.Duration(orchTimeoutName, defaultOrchTimeout, "hc timeout")

	pflag.String(tunnelAddressName, defaultTunnelAddress, "tunnel address")
	pflag.Duration(tunnelTimeoutName, defaultTunnelTimeout, "tunnel address")
