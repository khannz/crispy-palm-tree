...
func (removeRouteEntity *RemoveRouteEntity) RemoveRoute(hcDestIP, hcTunDestIP string, needRemoveTunnel bool, id string) error {
	return removeRouteEntity.routeWorker.RemoveRoute(hcDestIP, hcTunDestIP, needRemoveTunnel, id)
}
